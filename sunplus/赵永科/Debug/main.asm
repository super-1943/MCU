...
.debug
	.dw '.stabs "G:/yangsong/key/key/",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.debug
	.dw '.stabs "G:/yangsong/key/key/main.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
_delay:	.proc
.debug
	.dw '.stabs "G:/yangsong/key/key/mykey.h",0x84,0,0,',0,0,offset Ltext1, seg Ltext1,0x0d,0x0a
.code
.code
Ltext1:
.debug
...
.code
LM12:
	R2=[_freq]	// QImode move
	[_mem_freq]=R2	// QImode move
.debug
...
_sendword:	.proc
.debug
	.dw '.stabs "G:/yangsong/key/key/my7219.h",0x84,0,0,',0,0,offset Ltext2, seg Ltext2,0x0d,0x0a
.code
.code
Ltext2:
.debug
...
.code
.debug
	.dw '.stabs "delay_wave:F19",36,0,0,',0,0,offset _delay_wave,seg _delay_wave,0x0d,0x0a
.CODE
.public _delay_wave
_delay_wave:	.proc
.debug
	.dw '.stabs "G:/yangsong/key/key/wave.h",0x84,0,0,',0,0,offset Ltext3, seg Ltext3,0x0d,0x0a
.code
.code
Ltext3:
.debug
	.dw '.stabn 0x44,0,10,',0,0
	.dd LM157-_delay_wave
	.dw 0x0d,0x0a
.code
LM157:
	// total=0, vars=0
...
.debug
	...
	.dd LM161-_delay_wave
	.dw 0x0d,0x0a
.code
LM161:
.debug
	.dw '.stabn 0x44,0,15,',0,0
	.dd LM162-_delay_wave
	.dw 0x0d,0x0a
.code
LM162:
L100:
...
LM180:
	...
	R2 = R2 - R1	//subqi3
	[SP--]=R2	// QImode move
	call _delay_wave	// call without return value
	SP = SP + 1	//SP
.debug
	.dw '.stabn 0x44,0,38,',0,0
	.dd LM181-_wave
...
L118:
	R1=[BP]	// QImode move
	CMP R1,255	// QImode compare
	NSJNG L121	//QImode LE
	pc=L119	// Indirect jump
L121:
.debug
	.dw '.stabn 0x44,0,46,',0,0
	.dd LM186-_wave
...
.CODE
.debug
	.dw '.stabs "mem_freq:G4",32,0,0,',0,0,offset _mem_freq,seg _mem_freq,0x0d,0x0a
.CODE
.debug
	.dw '.stabs "mem_vol:G4",32,0,0,',0,0,offset _mem_vol,seg _mem_vol,0x0d,0x0a
.CODE
.public _SQUR
.iram
_SQUR:
...
_main:	.proc
.debug
	.dw '.stabs "G:/yangsong/key/key/main.c",0x84,0,0,',0,0,offset Ltext4, seg Ltext4,0x0d,0x0a
.code
.code
Ltext4:
.debug

...
P5.1---------------E(SCLK)
***********************************/
#define DataOut_12864   P5DIR|= 0x04
#define DataIn_12864    P5DIR&=~0x04
#define CS_1_12864      P5OUT|= 0x08
#define CS_0_12864      P5OUT&=~0x08
#define SID_1_12864     P5OUT|= 0x04
#define SID_0_12864     P5OUT&=~0x04
#define SCLK_1_12864    P5OUT|= 0x02
#define SCLK_0_12864    P5OUT&=~0x02
#define SID_IN          P5IN&0x04

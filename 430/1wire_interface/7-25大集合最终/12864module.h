...
#define CtrlDir_12864 P5DIR
#define DataBus_12864 P4OUT
#define InBus_12864   P4IN
...
const unsigned char hanzi_zuozhe[]=
{
 /*--  文字:  作  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
...
const unsigned char hanzi_qingshaohou[]=
{
    /*--  文字:  请  --*/
/*--  宋体12;  此字体下对应的点阵为：宽x高=16x16   --*/
...
//tab:点阵数据首地址，即数组名
//width:图片宽度，很重要！
//_8_height:点阵高度，应该为8 的倍数(即页数*8)，
//否则将多出的部分切除(右移时将多余部分消去)
void show_picture(
                  const unsigned char * tab,
                  unsigned char width,
                  unsigned char _8_height)

...
P3.5---------------E(SCLK)
***********************************/
#define DataOut_12864   P6DIR|= 0x40
#define DataIn_12864    P6DIR&=~0x40
#define CS_1_12864      P6OUT|= 0x80
#define CS_0_12864      P6OUT&=~0x80
#define SID_1_12864     P6OUT|= 0x40
#define SID_0_12864     P6OUT&=~0x40
#define SCLK_1_12864    P6OUT|= 0x20
#define SCLK_0_12864    P6OUT&=~0x20
#define SID_IN          P6IN&0x04

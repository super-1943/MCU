...
#define PIN_NUMLOCK				P3_bit.T0
#define PIN_CAPSLOCK				P3_bit.INT1
#define PIN_SCROLLLOCK				P3_bit.INT0
...
BYTE previousIEP1packet[8];
PBYTE iep1Buffer = 0x00;
...
//		P3.5 = (bVIDSTA>>3)&1;
		...
		if(bSuspended) {
            ...
            P3_bit.RxD = 0;      // since dip switch may tie P3.0 & P3.1 to ground
            P3_bit.TxD = 0;      
			
            IE_bit.EX1 = ENABLE;  // enable P2 interrupt
		...
		if(keypressBuffer[0] == 0x00) {
			...
			for(scanLine = 18; scanLine > 0; scanLine--) {
				...
				switch(scanLine) {
                    case 1: P1_bit.P10 = 0; break;
                    case 2: P1_bit.P11 = 0; break;
                    case 3: P1_bit.P12 = 0; break;
                    case 4: P1_bit.P13 = 0; break;
                    case 5: P1_bit.P14 = 0; break;
                    case 6: P1_bit.P15 = 0; break;
                    case 7: P1_bit.P16 = 0; break;
                    case 8: P1_bit.P17 = 0; break;
                    case 9: P3_bit.WR = 0; break;
                    case 10: P0_bit.P00 = 0; break;
                    case 11: P0_bit.P01 = 0; break;
                    case 12: P0_bit.P02 = 0; break;
                    case 13: P0_bit.P03 = 0; break;
                    case 14: P0_bit.P04 = 0; break;
                    case 15: P0_bit.P05 = 0; break;
                    case 16: P0_bit.P06 = 0; break;
                    case 17: P0_bit.P07 = 0; break;
                    case 18: P0_bit.P07 = 0; break;				

...
#pragma dataseg=TUSB2136_SETUPPACKET_SEG
__no_init tDEVICE_REQUEST tSetupPacket;
#pragma dataseg= default

#pragma dataseg=TUSB2136_EP0_EDB_SEG
__no_init tEDB0 tEndPoint0DescriptorBlock;
#pragma dataseg= default

#pragma dataseg=TUSB2136_IEP_EDB_SEG
__no_init tEDB tInputEndPointDescriptorBlock[3];
#pragma dataseg= default

#pragma dataseg=TUSB2136_OEP_EDB_SEG
__no_init tEDB tOutputEndPointDescriptorBlock[3];
#pragma dataseg= default

#pragma dataseg=TUSB2136_IEP0BUFFER_SEG
__no_init BYTE abIEP0Buffer[EP0_MAX_PACKET_SIZE];
#pragma dataseg= default

#pragma dataseg=TUSB2136_OEP0BUFFER_SEG
__no_init BYTE abOEP0Buffer[EP0_MAX_PACKET_SIZE];
#pragma dataseg= default

#pragma dataseg=TUSB2136_DESC_SEG             // 0xfe00
__no_init BYTE abDescriptor[SIZEOF_DEVICE_DESCRIPTOR];
...
#pragma dataseg=TUSB2136_OEP1_X_BUFFER_SEG    // 0xfd80
__no_init BYTE pbXBufferAddress[EP_MAX_PACKET_SIZE];
#pragma dataseg= default

#pragma dataseg=TUSB2136_OEP1_Y_BUFFER_SEG    // 0xfdc0
__no_init BYTE pbYBufferAddress[EP_MAX_PACKET_SIZE];
#pragma dataseg= default
...
typedef struct _tDEVICE_REQUEST_COMPARE
{
    ...
    VOID    (*pUsbFunction)();      // function pointer
...
VOID usbDecodeAndProcessUsbRequest()
{
...
#pragma vector=0x0013
__interrupt void P33Interrupt(void)
{
	// Disable all interrupts because this is critical code

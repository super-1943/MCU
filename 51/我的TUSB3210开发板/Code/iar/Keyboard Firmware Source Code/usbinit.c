...
#pragma dataseg=default
#pragma dataseg=TUSB2136_DESC_SEG
...
#pragma dataseg= default
#pragma dataseg=TUSB2136_IEP1_X_BUFFER_SEG
__no_init BYTE bufIEP1Buffer[8];
#pragma dataseg= default
...
{
	TCON_bit.IT0 = 0; // Edge-triggered
	IE_bit.EX0 = ENABLE; // Enable external 0 interrupt (USB interrupt source)
	IE_bit.EA = ENABLE; // Enable global interrupts

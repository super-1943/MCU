#ifndef _kkk_tusb3210_h
#define _kkk_tusb3210_h
...
#define bmRequestType			(* (unsigned char xdata *)0xFF00)
#define bRequest				(* (unsigned char xdata *)0xFF01)
#define bValueL					(* (unsigned char xdata *)0xFF02)
#define bValueH					(* (unsigned char xdata *)0xFF03)
#define bIndexL					(* (unsigned char xdata *)0xFF04)
#define bIndexH					(* (unsigned char xdata *)0xFF05)
#define bLengthL				(* (unsigned char xdata *)0xFF06)
#define bLengthH				(* (unsigned char xdata *)0xFF07)
